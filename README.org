...
For this tutorial we use a simple [[https://mc-stan.org/docs/2_19/stan-users-guide/linear-regression.html][linear regression]] example.
...
*Note*: We will detail option later in this tutorial.
...
[[file:figures/linRegHisto.png][file:~/GitHub/MathematicaStan/figures/linRegHisto.png]]
